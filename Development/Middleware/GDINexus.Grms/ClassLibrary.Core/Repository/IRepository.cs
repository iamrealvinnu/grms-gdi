...
/// <summary>
///     Represents the <see cref="IRepository" /> interface.
/// </summary>
public interface IRepository
{
    ...
    /// <summary>
    ///     This method takes an entity of type <typeparamref name="TEntity" />, delete the entity and returns
    ///     <see cref="void" />.
    ///     Deletion in the database will be affected after calling <see cref="SaveChangesAsync(CancellationToken)" /> method.
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of <see cref="Specification{T}" /> as parameter and returns
    ...
    /// <summary>
    ///     This method returns <see cref="List{T}" /> without any filter. Call only when you want to pull all the data from
    ///     the source.
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    /// <param name="asNoTracking">
    ...
    /// <summary>
    ///     This method takes a <see cref="Expression" /> as parameter and returns <see cref="List{TEntity}" />.
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    ...
    Task<List<TEntity>> GetEntityListAsync<TEntity>(Expression<Func<TEntity, bool>> condition,
        bool asNoTracking = false)
        where TEntity : class;

    /// <summary>
    ///     This method takes an object of <see cref="Specification{TEntity}" /> as parameter and returns
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of <see cref="Specification{T}" /> and a <see cref="System.Linq" />
    ///     select  query
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of <see cref="Specification{T}" /> and
    ///     <paramref name="selectExpression" /> as parameters and
