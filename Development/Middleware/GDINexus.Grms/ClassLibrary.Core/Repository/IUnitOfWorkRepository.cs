...
//
// NAME:			IUnitOfWorkRepository.cs
// AUTHOR:			Girish Girigowda
// COMPANY:			GDI Nexus
// DATE:			01/17/2025
// PURPOSE:			Unit of Work respository Interface
//
...
{
    /// <summary>
    ///     Gets <see cref="IQueryable" /> of the entity.
    /// </summary>
    IQueryable<TEntity> Entities { get; }

    /// <summary>
    ///     This method takes <see cref="IEnumerable{TEntity}" /> of entities, delete those entities and returns
    ///     <see cref="void" />.
    ///     Deletion in the database will be affected after calling
    ///     <see cref="IUnitOfWork.SaveChangesAsync(CancellationToken)" /> method.
    /// </summary>
    ...
    /// <summary>
    ///     This method takes one or more <see cref="Expression{Predicate}" /> and returns the count in <see cref="int" />
    ///     type.
    /// </summary>
    ...
    /// <summary>
    ///     This method takes <see cref="Expression{Predicate}" /> as parameter and returns <see cref="Task" /> of
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of <see cref="Specification{TEntity}" /> as parameter and returns
    ///     <typeparamref name="TEntity" />.
    /// </summary>
    /// <param name="specification">
    ///     A <see cref="Specification{TEntity}" /> <see cref="object" /> which contains all the conditions and criteria
    ...
    /// <summary>
    ///     This method returns <see cref="Task" /> without any filter. Call only when you want to pull all the data from the
    ///     source.
    /// </summary>
    /// <param name="asNoTracking">
    ///     A <see cref="bool" /> value which determines whether the return entity will be tracked by
    ...
    /// <summary>
    ///     This method takes an <see cref="Expression" /> as parameter and returns <see cref="Task" /> of
    ...
    /// </summary>
    /// <param name="specification">
    ///     A <see cref="Specification{TEntity}" /> object which contains all the conditions and criteria
    ///     on which data will be returned.
    /// </param>
    /// <param name="asNoTracking">
    ///     A <see cref="bool" /> value which determines whether the return entity will be tracked by
    ...
    /// <summary>
    ///     This method takes one or more <see cref="Expression{Predicate}" /> and returns the count in <see cref="long" />
    ///     type.
    /// </summary>
    /// <param name="conditions">The condition or conditions based on which count will be done.</param>
    /// <returns>Returns <see cref="Task" /> of <see cref="long" />.</returns>
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of <see cref="Specification{TEntity}" /> and
    ///     <paramref name="selectExpression" />
    ...
    /// <summary>
    ///     This method takes <paramref name="id" /> which is the primary key value of the entity and returns the specified
    ///     projected entity
    ...
    /// <summary>
    ///     This method takes <see cref="Expression{Func}" /> as parameter and returns <see cref="Task" /> of
    ///     <see cref="List{TProjectedType}" />.
    /// </summary>
    /// <typeparam name="TProjectedType">The projected type.</typeparam>
    /// <param name="condition">The condition on which entity list will be returned.</param>
    /// <param name="selectExpression">The <see cref="System.Linq" /> select query.</param>
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of <see cref="Specification{TTEntity}" /> and
    ///     <paramref name="selectExpression" />
    ...
    ///     Insertion in the database will be affected after calling
    ///     <see cref="IUnitOfWork.SaveChangesAsync(CancellationToken)" /> method.
    /// </summary>
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of type <typeparamref name="TEntity" /> to be inserted and returns
    ///     <see cref="Task" />.
    ///     Insertion in the database will be affected after calling
    ///     <see cref="IUnitOfWork.SaveChangesAsync(CancellationToken)" /> method.
    /// </summary>
    ...
    ///     Update in the database will be affected after calling
    ///     <see cref="IUnitOfWork.SaveChangesAsync(CancellationToken)" /> method.
    /// </summary>
    ...
    /// <summary>
    ///     This method takes an <see cref="object" /> of type <typeparamref name="TEntity" /> to be updated and returns
    ///     <see cref="void" />.
    ///     Update in the database will be affected after calling
    ///     <see cref="IUnitOfWork.SaveChangesAsync(CancellationToken)" /> method.
    /// </summary>
    ...
    /// <summary>
    ///     This method begins a transaction and returns
