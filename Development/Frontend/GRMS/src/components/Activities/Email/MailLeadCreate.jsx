...
function MailLeadCreate() {
    ...
    useEffect(() => {
        setLoading(true);
        Promise.all([fetchTableData(), fetchCurrentUser(), fetchLeadDetails(leadId)]).then(() => {
            setLoading(false);
        });
    }, []);
    ...
    useEffect(() => {
        if (!loading && tableData.length > 0) {
            ...
            const leadEntityType = entityTypes.find(
            ...
            if (leadEntityType) {
                setForm((prev) => ({
                    ...prev,
                    entityTypeId: leadEntityType.id,
                }));
            } else {
    ...
    return (
        <div className="min-h-screen bg-gray-200 p-4 md:p-8">
            <div className="mx-auto max-w-6xl">
                ...
                <h2 className="text-lg md:text-2xl font-bold mb-6 text-gray-800"> Compose Lead Email </h2>
                <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
                    ...
                    <div className="w-full lg:w-64 xl:w-72 mt-4 lg:mt-0">
                        <div className="bg-blue-50 rounded-lg shadow-md p-4 h-full">
                            ...
                            <div><strong>Lead Name:</strong> {form.company || "N/A"}</div>
