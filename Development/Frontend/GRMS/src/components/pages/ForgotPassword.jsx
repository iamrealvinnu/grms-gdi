...
//       // Redirect to the Ethereal email link
//       window.location.href = "https://ethereal.email/messages/65510dbcc600aa4766b14c3c/709";
//     } catch (error) {
//       console.error("Error:", error.response?.data);
//       toast.error(error.response?.data?.message || "Error sending reset link");
//     }
...
function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Open the Ethereal email link in a new tab
      window.open("https://ethereal.email/messages/65510dbcc600aa4766b14c3c/709", "_blank");
